...
csvFile = open('negative.csv', 'a', newline='', encoding='utf8')

csvWriter = csv.writer(csvFile)
csvWriter.writerow(['text'])

for i, tweet in enumerate(
        sntwitter.TwitterSearchScraper('#negative + since:2017-12-22 until:2022-12-22 lang:"en"').get_items()):
    if i > maxTweets:
        break
    csvWriter.writerow([tweet.content])
csvFile.close()

df = pd.read_csv('/Users/mucahidozcelik/Desktop/huaweiproject/negative.csv')
...
df2.to_csv("negative_tweets.csv")